...
public class QuestionPage {
	...
	public HBox createQuestionActionBar(VBox layout) {
		HBox questionActionBar = new HBox(10);
	...
	public HBox createPageBar(VBox parent) {
		...
		// New question button
		Button newAnswer = new Button("New Answer");
		newAnswer.setOnAction(a -> {
		...
		pageBar.getChildren().addAll(newAnswer, followUpButton, spacer, backButton);
